...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=True, EIoU=False, SIoU=False, ShapeIoU=False, eps=1e-7, scale=0.0):
    """
...
def bbox_inner_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=True, EIoU=False, SIoU=False, ShapeIoU=False, eps=1e-7, ratio=0.7, scale=0.0):
    """
    Calculate Intersection over Union (IoU) of box1(1, 4) to box2(n, 4).
